          ...
          child: ListView(
            ...
            children: <Widget>[
                ...
                children: [
                  Expanded(
                    ...
                    child: DropdownSearch<String>(
                      ...
                      showClearButton: true,
                      onChanged: print,
                      popupItemDisabled: (String? s) => s?.startsWith('I') ?? true,
                      selectedItem: "Tunisia",
                    ),
                  ),
                  Expanded(
              ...
              DropdownSearch<UserModel>.multiSelection(
                ...
                autoValidateMode: AutovalidateMode.onUserInteraction,
                validator: (u) => u == null || u.isEmpty ? "user field is required " : null,
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        isSelected ? Icon(Icons.check_box_outlined) : Container(),
                      ],
                    ),
                  );
                },
              ...
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        _openDropDownProgKey.currentState?.changeSelectedItem("No");
                      },
                      child: Text("set to 'NO'")),
                  Material(
                    child: ElevatedButton(
                        onPressed: () {
                          _openDropDownProgKey.currentState?.changeSelectedItem("Yes");
                        },
                        child: Text("set to 'YES'")),
                  ),
                  ElevatedButton(
                      onPressed: () {
                        _openDropDownProgKey.currentState?.changeSelectedItem('Blabla');
                      },
